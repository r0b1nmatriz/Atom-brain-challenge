...
def create_result_image(score, total, message):
    ...
    try:
        ...
        # Add title
        title_text = "Atom Brain Challenge"
        ...
        draw.text(((width - title_width) / 2, 50),
                  title_text,
                  font=title_font,
                  fill=(255, 69, 0))
        ...
        draw.text(((width - score_width) / 2,
                   circle_center_y - score_font.getbbox("0")[3] // 2),
                  score_text,
                  font=score_font,
                  fill=(255, 255, 255))
        ...
        draw.text(((width - message_width) / 2,
                   circle_center_y + circle_radius + 30),
                  message,
                  font=message_font,
                  fill=(0, 0, 0))
